...
export async function GET(context: APIContext) {
  return rss({
    ...
    description:
      "Professional resume and portfolio updates for Hamin Lee, Full Stack Engineer specializing in Web, On-device LLM, Real-time Streaming, and Robotics",
    ...
    items: [
      {
        ...
        link: "/en",
        description:
          "Professional resume of Hamin Lee, Full Stack Engineer with expertise in React, Next.js, TypeScript, Node.js, WebRTC, and On-device AI",
      ...
      },
      {
        ...
        link: "/ko",
        description:
          "웹, 온디바이스 LLM, 실시간 스트리밍, 로보틱스 전문 풀스택 엔지니어 이하민의 이력서",
        pubDate: new Date("2025-11-11"),
      ...
      },
      {
        ...
        link: "/en/portfolio",
        description:
          "Portfolio showcasing projects including Lami App (On-device LLM), Lami Robotics (Robot Control System), and Curiosity (AI Coding Agent)",
        pubDate: new Date("2025-11-11"),
      ...
      },
      {
        ...
        link: "/ko/portfolio",
        description:
          "라미앱(온디바이스 LLM), 라미 로보틱스(로봇 제어 시스템), 큐리오시티(AI 코딩 에이전트) 등 프로젝트 포트폴리오",
        pubDate: new Date("2025-11-11"),
      ...
      },
      {
        ...
        link: "/en/side",
        description:
          "Open source projects and NPM packages including Mugunghwa, Gauss Spiral, Edge Crypto, and more",
        pubDate: new Date("2025-11-11"),
