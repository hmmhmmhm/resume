        ...
        <div className="mb-6 lg:mb-10 relative z-20">
          ...
          <div className="space-y-6 text-xs sm:text-sm relative z-20">
            ...
            <div>
              ...
              <div className="space-y-2 opacity-90">
                <p>Curse Script converts JavaScript into an executable format using character substitution.</p>
                <p>The output is valid JavaScript that runs identically to the original code.</p>
              </div>
            </div>
          </div>
        </div>
