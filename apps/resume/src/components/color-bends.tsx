...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // Delay initial resize to ensure container is properly laid out
  ...
  return <div ref={containerRef} className={`w-full h-full relative overflow-hidden${className ? ` ${className}` : ''}`} style={style as any} />;
}
